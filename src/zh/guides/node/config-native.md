...
Leave these as the default options unless you have decided to use a directory other than `/srv/kelepool` for your Smartnode installation.


### Metrics

Kele Pool has the ability to integrate with Prometheus and Grafana to produce convenient web-based dashboards that let you observe your node's health at a glance:
...
If you haven't finished installing Kele Pool yet, return to the Native setup guide now.
