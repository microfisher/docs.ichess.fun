...
Your address's private key will now be stored in the `data/wallet` file (e.g. `~/.kelepool/data/wallet`), and the password for it will be stored in the `data/password` file (e.g. `~/.kelepool/data/password`).
